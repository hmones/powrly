		...
		<div id="post-body" class="columns-2">
			<div id="post-body-content">
				<table class="widefat spaced">
					...
					<thead>
						<?php if(ThemexCourse::$data['statistics']['user']['ID']!=0 && ThemexCourse::$data['statistics']['lesson']['ID']!=0) { ?>
						<tr>
							<th><?php _e('Question', 'academy'); ?></th>
							<th class="total_row"><?php _e('Answer', 'academy'); ?></th>
					...
					<tfoot>
						<?php if(ThemexCourse::$data['statistics']['user']['ID']!=0 && ThemexCourse::$data['statistics']['lesson']['ID']!=0) { ?>
							<?php foreach(ThemexCourse::$data['statistics']['lesson']['answers'] as $answer) { ?>
							<tr>
								<td><?php echo $answer['question']; ?></td>
								<td><?php echo $answer['answer']; ?></td>
								<td>
								<?php if($answer['result']=='correct') { ?>
						...
						<?php } else { ?>
							...
							<tr>
								...
								<?php } ?>
								<?php if(!empty(ThemexCourse::$data['statistics']['user']['ID'])) { ?>
								<td class="total_row"><a href="<?php echo admin_url('edit.php?post_type=course&page=statistics&user='.ThemexCourse::$data['statistics']['user']['ID'].'&course='.ThemexCourse::$data['statistics']['course']['ID'].'&lesson='.$lesson['ID']); ?>"><?php echo $lesson['lesson']; ?></a></td>
								<?php } else { ?>
