...
<?php } ?>
	...
	<a href="#" class="element-button medium submit-button left"><?php _e('Subscribe Now', 'academy'); ?></a>
	...
	<?php } else { ?>
		...
		<a href="#" class="element-button secondary medium submit-button left"><?php _e('Unsubscribe Now', 'academy'); ?></a>
